        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 ml-1 text-sm text-[#d1baba] rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
